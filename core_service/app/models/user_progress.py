from sqlalchemy import Column, Integer, String, Date, DateTime, Float, ForeignKey, UniqueConstraint, JSON, func
...
class UserSession(Base):
    ...
    user_telegram_id = Column(Integer, ForeignKey("user_progress.user_telegram_id"), primary_key=True)
